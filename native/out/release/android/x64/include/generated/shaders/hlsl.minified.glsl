...
#define td(f) register(b##f)
#define l6(f,a) cbuffer a:td(f){struct{
#define r7(a) }a;}
#define i2 struct g0{
...
#define Y4
#define Z4
#define D4(N,f,a) uniform Texture2D<Q>a:register(t##f)
#define c5(N,f,a) uniform Texture2D<g>a:register(t##f)
#define U2(N,f,a) uniform Texture2D<unorm g>a:register(t##f)
#define i5(N,f,a) uniform Texture2D<d>a:register(t##f)
...
#define T6(a,p,q,o6,Q8,X0) a.SampleLevel(p,c(q,o6),X0)
...
#define Z6
#define r5
#define C1(a,c0,G,v,S) cbuffer ci:td(vc){uint ug;uint a##di;uint a##ei;uint a##fi;}g0 main(c0 G,uint v:SV_VertexID,uint B7:SV_InstanceID){uint S=B7+ug;g0 R;
#define Q7(a,c0,G,v,S) g0 main(c0 G,uint v:SV_VertexID){g0 R;g L0;
#define D6(a,d3,e3,q3,r3,v) g0 main(d3 e3,q3 r3,uint v:SV_VertexID){g0 R;g L0;
#define D1(y5) R.L0=y5;}return R;
#define V2(Q1,a) Q1 main(g0 R):SV_Target{
#define p6(Q1,a) Q1 main(g0 R,bool q6:SV_IsFrontFace):SV_Target{
