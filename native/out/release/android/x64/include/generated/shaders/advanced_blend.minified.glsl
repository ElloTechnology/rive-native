...
#ifdef ENABLE_HSL_BLEND_MODES
case te:if(ENABLE_HSL_BLEND_MODES){k0.xyz=clamp(k0.xyz,T0(.0),T0(1.));d1=kb(k0.xyz,o0.xyz,o0.xyz);}break;case ue:if(ENABLE_HSL_BLEND_MODES){k0.xyz=clamp(k0.xyz,T0(.0),T0(1.));d1=kb(o0.xyz,k0.xyz,o0.xyz);}break;case ve:if(ENABLE_HSL_BLEND_MODES){k0.xyz=clamp(k0.xyz,T0(.0),T0(1.));d1=k9(k0.xyz,o0.xyz);}break;case we:if(ENABLE_HSL_BLEND_MODES){k0.xyz=clamp(k0.xyz,T0(.0),T0(1.));d1=k9(o0.xyz,k0.xyz);}break;
#endif
